...
import com.petproject.workflow.databinding.FragmentEmployeeInfoBinding
...
class EmployeeInfoFragment : Fragment() {
    ...
    private val binding: FragmentEmployeeInfoBinding get() = _binding!!
