...
object AuthConfig {
    const val AUTH_URI = "https://e-workflow.ru:9000/oauth2/authorize"
    const val TOKEN_URI = "https://e-workflow.ru:9000/oauth2/token"
    const val END_SESSION_URI = "https://e-workflow.ru:9000/connect/logout"
